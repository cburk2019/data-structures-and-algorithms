...
const longestString = (arr) => {
  ...
  // whiteboard interviews, edge cases

  // what am I to do if I come across an array that is not a string or a datatype that I'm not expecting

  // be clear on input and what expected output

  // applies to the empty array
};
...
// [] (character set, match any character in the set) is what is being "searched for" to replace/mutate/change
// () targets the () around 123
// - targets the - between 456-7890
// \s targets the whitespace

// return arr.forEach((word) => word.split("").join(""));
// };
